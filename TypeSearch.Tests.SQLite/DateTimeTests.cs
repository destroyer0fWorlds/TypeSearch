...
namespace TypeSearch.Tests.SQLite
{
    public class DateTimeTests
    {
        ...
        TestContext GetTestContext()
        {
            ...
            if (testEntity == null)
            {
                db.TestEntities.Add(new TestEntity() { DateTimeProperty = new DateTime(2000, 4, 12) });
                db.TestEntities.Add(new TestEntity() { DateTimeProperty = new DateTime(2004, 6, 10) });
                db.TestEntities.Add(new TestEntity() { DateTimeProperty = new DateTime(2007, 7, 21) });
                db.TestEntities.Add(new TestEntity() { DateTimeProperty = new DateTime(2012, 9, 15) });
                db.TestEntities.Add(new TestEntity() { DateTimeProperty = new DateTime(2016, 11, 7) });
                db.SaveChanges();
            }
