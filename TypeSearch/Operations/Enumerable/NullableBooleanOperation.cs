...
namespace TypeSearch.Operations.Enumerable
{
        ...
        where T : class
    {
        ...
        public NullableBooleanOperation(string collectionName, string propertyName, LogicalOperator @operator, FilterCriteria<T> where) : base(collectionName, propertyName, @operator, where)
        {
